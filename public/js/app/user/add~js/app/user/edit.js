        ...
        [
          ...
          _c(
            ...
            [
              _c("base-select", {
                attrs: {
                  options: _vm.preRequisite.roles,
                  label: _vm.formLabels.role,
                  error: _vm.formErrors.role,
                  required: "",
                  "preselect-first": ""
                },
                on: {
                  "update:error": function($event) {
                    return _vm.$set(_vm.formErrors, "role", $event)
                  }
                },
                model: {
...
//# sourceMappingURL=edit.js.map?id=422df0b3da5745982dde