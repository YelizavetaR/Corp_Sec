        ...
        <div class="col-12 col-md-6 mb-5">
          ...
          <div class="color-list mt-3">
            <base-radio
              ...
              :key="color.key"
              :value="color.key"
              v-model="formData.topNavbarColor"
              class="color-item mb-2"
              :type="color.key"
            >
              {{ color.title }}
            </base-radio>
          ...
          <div class="row">
            <div class="col-12 mb-5">
              <h6 class="font-weight-700">
                {{ $t("config.ui.fixed_on_top") }}
              </h6>
              <div class="d-flex align-items-center mt-3">
                <base-radio
                  :value="false"
                  v-model="formData.topNavbarFixed"
                  inline
                >
                  {{ $t("config.ui.disable") }}
                </base-radio>
            ...
            <div class="col-12 mb-5">
              ...
              <div class="d-flex align-items-center mt-3">
                <base-radio
                  :value="false"
                  v-model="formData.topNavbarLogoLight"
                  inline
                >
                  {{ $t("config.ui.disable") }}
                </base-radio>
            ...
            <div class="col-12 mb-5">
              <h6 class="font-weight-700">{{ $t("config.ui.hide_navbar") }}</h6>
              <div class="d-flex align-items-center mt-3">
                <base-radio
                  :value="false"
                  v-model="formData.topNavbarHide"
                  inline
                >
                  {{ $t("config.ui.disable") }}
                </base-radio>
