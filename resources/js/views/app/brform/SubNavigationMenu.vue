<template>
  <div class="component-navigation-menu-wrapper">
    <ul :class="['component-navigation-menu list-unstyled']">
      <template
        v-for="(navItem, j) in navigation"
        v-if="!navItem.meta.isHiddenNav"
      >
        <menu-item
...
<script>
import MenuItem from "./sidebar-menu/app-sidebar-menu-item";
export default {
...
.component-navigation-menu-wrapper {
  ul.component-navigation-menu {
    ...
    > li {
      ...
      &:first-child > a:hover,
      &:first-child > a.has-children.is-open {
        border-radius: $border-radius $border-radius 0 0;
      }

      &:last-child > a:hover,
      &:last-child > a.has-children.is-open {
