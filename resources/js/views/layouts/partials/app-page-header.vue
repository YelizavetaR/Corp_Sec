    ...
    <div class="page-header-content">
      <div class="header-breadcrumb-wrapper">
        ...
        >
          ...
          ><span :key="pageTitle"
            >{{ pageTitle }}
            <span class="text-muted text-sm">{{ pageSubTitle }}</span></span
          >
        </transition-group>
  ...
  computed: {
    ...
    pageTitle() {
      ...
      return this.$route.meta.trans
        ? this.$t(this.$route.meta.trans, {
            attribute:
              this.$t(this.$route.meta.midTitle) +
              " " +
    ...
    pageSubTitle() {
      return this.uiConfigs.pageHeader && this.uiConfigs.pageHeader.subTitle
        ? this.uiConfigs.pageHeader.subTitle
        : "";
    },
  },
};
